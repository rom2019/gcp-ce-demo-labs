...
```
### Architecture - HA VPN & BGP Configuration (Edge ↔ Hub)
```
=========================================================================================================
...
| 핵심 항목 | 주의사항 및 자주 하는 실수|
|---|---|
| **Edge Router BGP 광고** | Edge 측 BGP Session 설정 시, Advertised routes는 Hub 방향으로 자신의 대역(ALL_SUBNETS)뿐만 아니라, 온프레미스 대역(192.168.1.0/24)을 수동으로 추가하여(Custom Advertisement) 광고해야 합니다. |
